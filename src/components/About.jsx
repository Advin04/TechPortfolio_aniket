...
export const About = () => {
  return (
    <section className="section bg-[var(--container-color)] relative overflow-hidden pt-20" id="about">
      {/* Top Seamless Gradient Transition from Hero */}
      <div className="absolute top-0 left-0 w-full h-28 bg-gradient-to-b from-[var(--body-color)] via-[var(--container-color)]/60 to-[var(--container-color)] pointer-events-none z-10" />
